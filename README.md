...
2. What is an event?
-------------------------
An event is the way a user interacts with a webpage.
-------------------------

3. What is an event listener?

-------------------------
An event listener listens for a specific type of user interaction to trigger something else to happen on the web page.
-------------------------

4. Why would we convert a NodeList into an Array?

-------------------------
Nodelist are array-like but dont feature all the same methods as an arrya like .forEach.
-------------------------

5. What is a component?

-------------------------
It is a way to reuse HTML, CSS, and JS.
-------------------------
